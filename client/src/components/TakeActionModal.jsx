          ...
          <div className="p-4 md:p-5">
            ...
            <div className="flex flex-col md:flex-row md:space-x-4 mt-4">
              <button
                ...
                className="w-full text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
               >
                Take Action
              </button>
            </div>
